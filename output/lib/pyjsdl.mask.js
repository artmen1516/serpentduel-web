...
$pyjs['loaded_modules']['pyjsdl.mask'] = function (__mod_name__) {
	...
	var $cmp1,$cmp2,$attr2,$attr1,$bool1;
	...
	$m['from_surface'] = function(surface, threshold) {
		...
		var height,$iter2_type,$iter2_iter,$attr10,width,$iter1_array,xpix,$attr9,$attr8,$iter1_nextval,$attr3,$attr5,$attr4,$attr7,$attr6,$bool2,$bool3,$iter2_idx,$bool4,$attr15,$attr14,$attr16,$attr11,pixels,$attr13,$attr12,$cmp4,$iter2_nextval,$iter1_type,$cmp3,$iter1_iter,mask,i,$iter1_idx,y,x,$iter2_array;
		mask = (typeof Mask == "undefined"?$m['Mask']:Mask)($p['tuple']([surface['width'], surface['height']]));
		if ((($bool3=!(($bool2=mask['bit']) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
			false :
			(typeof $bool2=='object'?
		...
		while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
			...
			while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
				x = $iter2_nextval;
				if ((($bool4=((($cmp3=surface['_getPixel'](pixels, (i)+(x)))===($cmp4=threshold)?0:
	...
	$m['from_threshold'] = function(surface, color, threshold) {
		...
		var $attr35,$bool10,$bool11,$bool12,$9,$bool14,$bool15,$bool16,$cmp20,$iter4_type,$attr39,$attr38,$cmp12,$iter6_type,$iter3_iter,$iter5_idx,$iter7_type,$and8,$bool13,$and1,$and2,$and3,$and4,$and5,$and6,$and7,$iter6_array,$bool6,$bool7,$iter7_idx,$bool5,$bool8,$bool9,$iter7_nextval,$iter4_nextval,x,$iter5_nextval,$iter5_array,$iter6_iter,$iter6_idx,pixels,c,$cmp11,col,$cmp10,$iter3_array,height,$attr40,$iter5_type,$iter4_iter,$iter3_nextval,$32,width,$iter7_iter,$attr33,$attr32,$attr31,$attr30,$attr37,$attr36,$8,$attr34,$6,$7,$4,$5,$2,$3,$1,$14,$15,$16,$17,$10,$11,$12,$13,$18,$19,$36,$iter5_iter,$iter4_array,ix,$35,$cmp9,$33,$attr20,$attr21,$attr22,$attr23,$attr24,$attr25,$attr26,$attr27,$attr28,$attr29,$iter6_nextval,$29,$28,$iter3_idx,$21,$20,$23,$22,$25,$24,$27,$26,$eq8,$eq2,$eq3,$eq1,$eq6,$eq7,$eq4,$eq5,$cmp15,$cmp14,$cmp17,$cmp16,$attr19,$attr18,$cmp13,$iter3_type,$attr17,$cmp19,$cmp18,xpix,$cmp5,$cmp7,$cmp6,$38,i,$37,$34,$iter7_array,mask,$cmp8,$30,$31,$iter4_idx,y;
		mask = (typeof Mask == "undefined"?$m['Mask']:Mask)($p['tuple']([surface['width'], surface['height']]));
		if ((($bool6=!(($bool5=mask['bit']) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
			false :
			(typeof $bool5=='object'?
		...
		pixels = surface['impl']['getImageData'](0, 0, surface['width'], surface['height']);
		if ((($bool7=(($eq1=threshold)===($eq2=$p['tuple']([0, 0, 0, 255]))&&$eq1===null?true:
			...
			while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
				...
				while (typeof ($iter4_nextval=($iter4_type?($iter4_type > 0?$iter4_iter.next(true,false):$p['wrapped_next']($iter4_iter)):$iter4_array[$iter4_idx++])) != 'undefined') {
					x = $iter4_nextval;
					ix = (i)+(x);
					if ((($bool11=((($bool8=$and1=(($eq3=surface['_getPixel'](pixels, ix))===($eq4=(typeof ($1=color)['__array'] != 'undefined'?
							...
							(typeof $bool8['__nonzero__']=='function'?
								...
								(typeof $bool8['__len__']=='function'?
									($bool8['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?((($bool9=$and2=(($eq5=surface['_getPixel'](pixels, (ix)+(1)))===($eq6=(typeof ($3=color)['__array'] != 'undefined'?
							...
							(typeof $bool9['__nonzero__']=='function'?
								...
								(typeof $bool9['__len__']=='function'?
									($bool9['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?((($bool10=$and3=(($eq7=surface['_getPixel'](pixels, (ix)+(2)))===($eq8=(typeof ($5=color)['__array'] != 'undefined'?
							...
							(typeof $bool10['__nonzero__']=='function'?
								...
								(typeof $bool10['__len__']=='function'?
									($bool10['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?((((($cmp5=surface['_getPixel'](pixels, (ix)+(3)))===($cmp6=(typeof ($7=threshold)['__array'] != 'undefined'?
						((typeof $7['__array'][$8=3]) != 'undefined'?$7['__array'][$8]:
							$7['__getitem__']($8)):
							$7['__getitem__'](3)))?0:
						(typeof $cmp5==typeof $cmp6 && ((typeof $cmp5 == 'number')||(typeof $cmp5 == 'string')||(typeof $cmp5 == 'boolean'))?
							($cmp5 == $cmp6 ? 0 : ($cmp5 < $cmp6 ? -1 : 1)):
							$p['cmp']($cmp5, $cmp6))))|1) == 1):$and3):$and2):$and1)) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
							false :
			...
			while (typeof ($iter5_nextval=($iter5_type?($iter5_type > 0?$iter5_iter.next(true,false):$p['wrapped_next']($iter5_iter)):$iter5_array[$iter5_idx++])) != 'undefined') {
				...
				i = $tupleassign3[0];
				c = $tupleassign3[1];
				if ((($bool12=(typeof ($9=threshold)['__array'] != 'undefined'?
					((typeof $9['__array'][$10=i]) != 'undefined'?$9['__array'][$10]:
						$9['__getitem__']($10)):
						$9['__getitem__'](i))) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
						false :
			...
			while (typeof ($iter6_nextval=($iter6_type?($iter6_type > 0?$iter6_iter.next(true,false):$p['wrapped_next']($iter6_iter)):$iter6_array[$iter6_idx++])) != 'undefined') {
				...
				while (typeof ($iter7_nextval=($iter7_type?($iter7_type > 0?$iter7_iter.next(true,false):$p['wrapped_next']($iter7_iter)):$iter7_array[$iter7_idx++])) != 'undefined') {
					x = $iter7_nextval;
					ix = (i)+(x);
					if ((($bool16=((($bool13=$and5=(((($cmp7=(typeof ($25=col)['__array'] != 'undefined'?
						((typeof $25['__array'][$26='r1']) != 'undefined'?$25['__array'][$26]:
							$25['__getitem__']($26)):
							$25['__getitem__']('r1')))===($cmp8=($compare1 = surface['_getPixel'](pixels, ix)))?0:
						(typeof $cmp7==typeof $cmp8 && ((typeof $cmp7 == 'number')||(typeof $cmp7 == 'string')||(typeof $cmp7 == 'boolean'))?
							($cmp7 == $cmp8 ? 0 : ($cmp7 < $cmp8 ? -1 : 1)):
							$p['cmp']($cmp7, $cmp8))) == -1)&&((($cmp9=$compare1)===($cmp10=($compare2 = (typeof ($27=col)['__array'] != 'undefined'?
							...
							(typeof $bool13['__nonzero__']=='function'?
								...
								(typeof $bool13['__len__']=='function'?
									($bool13['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?((($bool14=$and6=(((($cmp11=(typeof ($29=col)['__array'] != 'undefined'?
						((typeof $29['__array'][$30='g1']) != 'undefined'?$29['__array'][$30]:
							$29['__getitem__']($30)):
							$29['__getitem__']('g1')))===($cmp12=($compare3 = surface['_getPixel'](pixels, (ix)+(1))))?0:
						(typeof $cmp11==typeof $cmp12 && ((typeof $cmp11 == 'number')||(typeof $cmp11 == 'string')||(typeof $cmp11 == 'boolean'))?
							($cmp11 == $cmp12 ? 0 : ($cmp11 < $cmp12 ? -1 : 1)):
							$p['cmp']($cmp11, $cmp12))) == -1)&&((($cmp13=$compare3)===($cmp14=($compare4 = (typeof ($31=col)['__array'] != 'undefined'?
						((typeof $31['__array'][$32='g2']) != 'undefined'?$31['__array'][$32]:
							$31['__getitem__']($32)):
							$31['__getitem__']('g2'))))?0:
						(typeof $cmp13==typeof $cmp14 && ((typeof $cmp13 == 'number')||(typeof $cmp13 == 'string')||(typeof $cmp13 == 'boolean'))?
							($cmp13 == $cmp14 ? 0 : ($cmp13 < $cmp14 ? -1 : 1)):
							$p['cmp']($cmp13, $cmp14))) == -1))) === null || $bool14 === false || $bool14 === 0 || $bool14 === '' ?
						false :
							...
							(typeof $bool14['__nonzero__']=='function'?
								...
								(typeof $bool14['__len__']=='function'?
									($bool14['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?((($bool15=$and7=(((($cmp15=(typeof ($33=col)['__array'] != 'undefined'?
						((typeof $33['__array'][$34='b1']) != 'undefined'?$33['__array'][$34]:
							$33['__getitem__']($34)):
							$33['__getitem__']('b1')))===($cmp16=($compare5 = surface['_getPixel'](pixels, (ix)+(2))))?0:
						(typeof $cmp15==typeof $cmp16 && ((typeof $cmp15 == 'number')||(typeof $cmp15 == 'string')||(typeof $cmp15 == 'boolean'))?
							($cmp15 == $cmp16 ? 0 : ($cmp15 < $cmp16 ? -1 : 1)):
							$p['cmp']($cmp15, $cmp16))) == -1)&&((($cmp17=$compare5)===($cmp18=($compare6 = (typeof ($35=col)['__array'] != 'undefined'?
						...
						(typeof $cmp17==typeof $cmp18 && ((typeof $cmp17 == 'number')||(typeof $cmp17 == 'string')||(typeof $cmp17 == 'boolean'))?
							...
							$p['cmp']($cmp17, $cmp18))) == -1))) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
						false :
							...
							(typeof $bool15['__nonzero__']=='function'?
								...
								(typeof $bool15['__len__']=='function'?
									($bool15['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?((($cmp19=surface['_getPixel'](pixels, (ix)+(3)))===($cmp20=(typeof ($37=col)['__array'] != 'undefined'?
						...
						(typeof $cmp19==typeof $cmp20 && ((typeof $cmp19 == 'number')||(typeof $cmp19 == 'string')||(typeof $cmp19 == 'boolean'))?
							...
							$p['cmp']($cmp19, $cmp20))) == 1):$and7):$and6):$and5)) === null || $bool16 === false || $bool16 === 0 || $bool16 === '' ?
							false :
	...
	$m['Mask'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(size) {
			...
			var $attr43,bitset,$iter8_idx,$39,$iter8_array,$iter8_iter,$attr44,$attr42,$iter8_nextval,$attr41,$42,$41,$40,$iter8_type;
			self['width'] = $p['float_int']((typeof ($39=size)['__array'] != 'undefined'?
				((typeof $39['__array'][$40=0]) != 'undefined'?$39['__array'][$40]:
					$39['__getitem__']($40)):
					$39['__getitem__'](0)));
			self['height'] = $p['float_int']((typeof ($41=size)['__array'] != 'undefined'?
				((typeof $41['__array'][$42=1]) != 'undefined'?$41['__array'][$42]:
					$41['__getitem__']($42)):
					$41['__getitem__'](1)));
			self['bit'] = $p['list']([]);
			$iter8_iter = $m['range'](self['height']);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('__repr__', function() {
			...
			var $attr46,$attr47,$attr45,$attr48;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('get_at', function(pos) {
			...
			var $attr53,$attr54,$48,$43,$46,$47,$45,$44;
			return (typeof ($45=self['bit'])['__array'] != 'undefined'?
				((typeof $45['__array'][$46=(typeof ($43=pos)['__array'] != 'undefined'?
				((typeof $43['__array'][$44=1]) != 'undefined'?$43['__array'][$44]:
					$43['__getitem__']($44)):
					$43['__getitem__'](1))]) != 'undefined'?$45['__array'][$46]:
					$45['__getitem__']($46)):
					$45['__getitem__']((typeof ($43=pos)['__array'] != 'undefined'?
				((typeof $43['__array'][$44=1]) != 'undefined'?$43['__array'][$44]:
					$43['__getitem__']($44)):
					$43['__getitem__'](1))))['get']((typeof ($47=pos)['__array'] != 'undefined'?
	...
	, 1, [null,null,['self'],['pos']]);
		...
		$method = $pyjs__bind_method2('set_at', function(pos, value) {
			...
			var $attr55,$attr56,$49,$50,$51,$52,$53,$54;
			(typeof ($51=self['bit'])['__array'] != 'undefined'?
				((typeof $51['__array'][$52=(typeof ($49=pos)['__array'] != 'undefined'?
				((typeof $49['__array'][$50=1]) != 'undefined'?$49['__array'][$50]:
					$49['__getitem__']($50)):
					$49['__getitem__'](1))]) != 'undefined'?$51['__array'][$52]:
					$51['__getitem__']($52)):
					$51['__getitem__']((typeof ($49=pos)['__array'] != 'undefined'?
				((typeof $49['__array'][$50=1]) != 'undefined'?$49['__array'][$50]:
					$49['__getitem__']($50)):
					$49['__getitem__'](1))))['set']((typeof ($53=pos)['__array'] != 'undefined'?
				((typeof $53['__array'][$54=0]) != 'undefined'?$53['__array'][$54]:
					$53['__getitem__']($54)):
					$53['__getitem__'](0)), value);
			return null;
		}
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('invert', function() {
			...
			var $attr58,$iter11_iter,$iter11_type,$attr57,bitset,$iter11_array,$iter11_nextval,$iter11_idx;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('overlap', function(mask, offset) {
			...
			var $bool18,$bool19,$bool17,$cmp21,$cmp22,$cmp23,$cmp24,$cmp25,$cmp26,$cmp27,y1,y2,$iter13_array,$attr68,$attr69,$attr64,$attr65,$attr67,$attr60,$attr61,$attr62,$attr63,$69,$bool20,$attr66,$65,$64,$67,$66,$61,$60,$63,$62,$and9,$and10,$iter13_idx,$cmp28,x2,x1,$attr59,$68,$70,$iter13_nextval,$iter13_iter,h,$iter13_type,$58,$59,$bool21,w,y,$attr70,$55,$56,$57;
			if ((($bool17=((($cmp21=(typeof ($55=offset)['__array'] != 'undefined'?
				((typeof $55['__array'][$56=0]) != 'undefined'?$55['__array'][$56]:
					$55['__getitem__']($56)):
					$55['__getitem__'](0)))===($cmp22=0)?0:
					...
					(typeof $bool17=='object'?
						(typeof $bool17['__nonzero__']=='function'?
							...
							(typeof $bool17['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				x1 = (typeof ($57=offset)['__array'] != 'undefined'?
				...
				x1 = 0;
				x2 = -((typeof ($59=offset)['__array'] != 'undefined'?
					((typeof $59['__array'][$60=0]) != 'undefined'?$59['__array'][$60]:
						$59['__getitem__']($60)):
						$59['__getitem__'](0)));
			}
			if ((($bool18=((($cmp23=(typeof ($61=offset)['__array'] != 'undefined'?
				((typeof $61['__array'][$62=1]) != 'undefined'?$61['__array'][$62]:
					$61['__getitem__']($62)):
					$61['__getitem__'](1)))===($cmp24=0)?0:
					...
					(typeof $bool18=='object'?
						(typeof $bool18['__nonzero__']=='function'?
							...
							(typeof $bool18['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				y1 = (typeof ($63=offset)['__array'] != 'undefined'?
				...
				y1 = 0;
				y2 = -((typeof ($65=offset)['__array'] != 'undefined'?
			...
			if ((($bool20=((($bool19=$and9=((($cmp25=w)===($cmp26=0)?0:
				...
				while (typeof ($iter13_nextval=($iter13_type?($iter13_type > 0?$iter13_iter.next(true,false):$p['wrapped_next']($iter13_iter)):$iter13_array[$iter13_idx++])) != 'undefined') {
					y = $iter13_nextval;
					if ((($bool21=(typeof ($67=self['bit'])['__array'] != 'undefined'?
						((typeof $67['__array'][$68=(y1)+(y)]) != 'undefined'?$67['__array'][$68]:
							$67['__getitem__']($68)):
							$67['__getitem__']((y1)+(y)))['get'](x1, (x1)+(w))['intersects']((typeof ($69=mask['bit'])['__array'] != 'undefined'?
						((typeof $69['__array'][$70=(y2)+(y)]) != 'undefined'?$69['__array'][$70]:
							$69['__getitem__']($70)):
							$69['__getitem__']((y2)+(y)))['get'](x2, (x2)+(w)))) === null || $bool21 === false || $bool21 === 0 || $bool21 === '' ?
							false :
	...
	, 1, [null,null,['self'],['mask'],['offset']]);
		...
		$method = $pyjs__bind_method2('toString', function(bit) {
			...
			var $72,$73,$iter14_array,$71,$iter14_type,$74,cbit,cbitset,bitset,$iter14_iter,bitstr,$iter14_idx,$iter14_nextval;
			cbit = $p['dict']([[true, (typeof ($71=bit)['__array'] != 'undefined'?
				((typeof $71['__array'][$72=0]) != 'undefined'?$71['__array'][$72]:
					$71['__getitem__']($72)):
					$71['__getitem__'](0))], [false, (typeof ($73=bit)['__array'] != 'undefined'?
			...
			while (typeof ($iter14_nextval=($iter14_type?($iter14_type > 0?$iter14_iter.next(true,false):$p['wrapped_next']($iter14_iter)):$iter14_array[$iter14_idx++])) != 'undefined') {
				...
				cbitset['extend'](function(){
					var $76,$iter15_iter,$75,i,$iter15_array,$attr72,$collcomp1,$iter15_idx,$attr71,$iter15_nextval,$iter15_type;
	$collcomp1 = $p['list']();
				$iter15_iter = $m['range'](self['width']);
				...
				while (typeof ($iter15_nextval=($iter15_type?($iter15_type > 0?$iter15_iter.next(true,false):$p['wrapped_next']($iter15_iter)):$iter15_array[$iter15_idx++])) != 'undefined') {
					i = $iter15_nextval;
					$collcomp1['append']((typeof ($75=cbit)['__array'] != 'undefined'?
						((typeof $75['__array'][$76=bitset['get'](i)]) != 'undefined'?$75['__array'][$76]:
							$75['__getitem__']($76)):
							$75['__getitem__'](bitset['get'](i))));
				}
...
/*
PYJS_DEPS: ['pyjsdl.pyjsarray.BitSet', 'pyjsdl', 'pyjsdl.pyjsarray', 'pyjsdl.color.Color', 'pyjsdl.color', 'sys', 'pyjsdl.util._range', 'pyjsdl.util']
*/
