...
$pyjs['loaded_modules']['pyjsdl.util'] = function (__mod_name__) {
	...
	$m['PyjsMode'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			var $tupleassign1 = $p['__ass_unpack'](self['test_mode'](), 2, null);
	...
	, 1, [null,null,['self']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('test_mode', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			}
			var $and1,$bool13,$bool14,$attr25,$attr26,$attr27,$attr28,$and2;
			if ((($bool14=((($bool13=$and1=self['getattr_call']) === null || $bool13 === false || $bool13 === 0 || $bool13 === '' ?
				false :
					...
					(typeof $bool13['__nonzero__']=='function'?
						...
						(typeof $bool13['__len__']=='function'?
							($bool13['__len__']()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?self['eq_call']:$and1)) === null || $bool14 === false || $bool14 === 0 || $bool14 === '' ?
					false :
	...
	, 1, [null,null,['self']]);
		$cls_definition['test_mode'] = $method;
		$method = $pyjs__bind_method2('test_getattr', function() {
			...
			var $eq8,$attr29,$attr30,$eq7;
			return (($eq7=$m['Rect'](0, 0, 20, 20)['center'])===($eq8=$p['tuple']([10, 10]))&&$eq7===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_eq', function() {
			...
			var $eq10,$eq9;
			return (($eq9=$m['Rect'](0, 0, 20, 20))===($eq10=$m['Rect'](0, 0, 20, 20))&&$eq9===null?true:
	...
	$m['env']['set_env']('pyjs_mode', $m['PyjsMode']());
	...
	$m['_dict'] = (function(){
		...
		$method = $pyjs__bind_method2('values', function() {
			...
			return $p['dict']['values'](self)['__iter__']();
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('items', function() {
			...
			return $p['dict']['items'](self)['__iter__']();
		}
	, 1, [null,null,['self']]);
		...
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('_dict', $p['tuple']($bases), $data);
	})();
	$m['_next'] = function(obj) {

		return obj['next']();
	};
	$m['_next']['__name__'] = '_next';

	$m['_next']['__bind_type__'] = 0;
	$m['_next']['__args__'] = [null,null,['obj']];
	try {
		$m['_range'] = $p['xrange'];
	} catch($pyjs_try_err) {
...
/*
PYJS_DEPS: ['pyjsdl.time.Time', 'pyjsdl', 'pyjsdl.time', 'pyjsdl.rect.Rect', 'pyjsdl.rect', 'pyjsdl.env']
*/
