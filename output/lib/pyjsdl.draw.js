...
$pyjs['loaded_modules']['pyjsdl.draw'] = function (__mod_name__) {
	...
	$m['__doc__'] = 'Draw shapes';
	$m['_return_rect'] = true;
	$m['rect'] = function(surface, color, rect, width) {
		if (typeof width == 'undefined') width=arguments['callee']['__args__'][5][1];
		var $attr20,$attr21,$attr22,$bool8,$bool9,$attr1,$attr13,$bool7,$attr9,$attr8,$attr2,$eq2,$eq3,$attr3,$eq1,$attr5,$attr4,$attr7,$attr6,$bool2,$bool3,$bool1,$bool6,$eq4,$bool4,$bool5,$attr15,$attr14,$attr17,$attr16,$attr11,$attr10,$attr12,_rect,$attr19,$attr18;
		...
		if ((($bool8=!(($bool7=$m['_return_rect']) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
			false :
			(typeof $bool7=='object'?
	...
	$m['rect']['__name__'] = 'rect';

	$m['rect']['__bind_type__'] = 0;
	$m['rect']['__args__'] = [null,null,['surface'],['color'],['rect'],['width', 0]];
	$m['circle'] = function(surface, color, position, radius, width) {
		if (typeof width == 'undefined') width=arguments['callee']['__args__'][6][1];
		var $bool11,$bool12,$bool13,$bool14,$bool15,$bool17,$attr23,$attr24,$attr25,$attr26,$attr27,$attr28,$bool10,$eq8,$eq6,$eq7,$eq5,$9,$bool16,$8,$6,$7,$4,$5,$2,$3,$1,$10,$11,$12;
		surface['beginPath']();
		...
		if ((($bool16=!(($bool15=$m['_return_rect']) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
			false :
	...
	$m['circle']['__name__'] = 'circle';

	$m['circle']['__bind_type__'] = 0;
	$m['circle']['__args__'] = [null,null,['surface'],['color'],['position'],['radius'],['width', 0]];
	$m['ellipse'] = function(surface, color, rect, width) {
		if (typeof width == 'undefined') width=arguments['callee']['__args__'][5][1];
		var $bool18,$bool19,$eq11,$attr46,$attr47,$attr44,$attr45,$attr42,$attr43,$attr40,$attr41,$eq10,$attr29,$eq12,$attr48,$attr49,$bool24,$bool25,$bool27,$bool26,$bool21,$bool20,$bool23,$bool22,$eq9,$attr33,$attr32,$attr31,$attr30,$attr37,$attr36,$attr35,$attr34,$attr39,$attr38,_rect,$attr58,$cmp1,$cmp2,$attr51,$attr50,$attr53,$attr52,$attr55,$attr54,$attr57,$attr56,radius;
		...
		if ((($bool26=!(($bool25=$m['_return_rect']) === null || $bool25 === false || $bool25 === 0 || $bool25 === '' ?
			false :
	...
	$m['ellipse']['__name__'] = 'ellipse';

	$m['ellipse']['__bind_type__'] = 0;
	$m['ellipse']['__args__'] = [null,null,['surface'],['color'],['rect'],['width', 0]];
	$m['arc'] = function(surface, color, rect, start_angle, stop_angle, width) {
		if (typeof width == 'undefined') width=arguments['callee']['__args__'][7][1];
		var $attr89,$attr93,$attr98,$eq18,$eq19,radius,$eq13,$eq14,$eq15,$eq16,$eq17,$attr82,$attr83,$attr80,$attr81,$attr68,$attr69,$attr84,$attr64,$attr65,$attr66,$attr67,$attr60,$attr61,$attr62,$attr63,$attr90,$attr104,$attr105,$attr102,$attr103,$attr100,$attr101,$attr85,$bool29,$bool28,$bool40,$attr59,$bool43,$bool42,$bool41,$attr94,$attr99,$eq21,$eq20,$eq22,$attr95,$attr106,$attr86,$attr92,$attr87,_rect,$cmp4,$attr97,$attr96,$attr91,$cmp3,$attr79,$attr78,$attr77,$attr76,$attr75,$attr74,$attr73,$attr72,$attr71,$attr70,$bool32,$bool33,$bool30,$bool31,$bool36,$bool37,$bool34,$bool35,$bool38,$bool39,$attr88;
		...
		if ((($bool42=!(($bool41=$m['_return_rect']) === null || $bool41 === false || $bool41 === 0 || $bool41 === '' ?
			false :
	...
	$m['arc']['__args__'] = [null,null,['surface'],['color'],['rect'],['start_angle'],['stop_angle'],['width', 1]];
	$m['polygon'] = function(surface, color, pointlist, width) {
		if (typeof width == 'undefined') width=arguments['callee']['__args__'][5][1];
		var $bool50,$bool51,point,$iter1_iter,xpts,xmin,ymin,ymax,$attr107,$iter1_array,$attr108,$attr109,$bool47,$bool46,$bool45,$bool44,$iter1_nextval,$bool49,$bool48,$eq23,$eq25,$eq24,$eq26,ypts,$14,$iter1_type,$13,$attr111,$attr110,$attr112,$iter1_idx,xmax;
		surface['beginPath']();
		...
		if ((($bool50=!(($bool49=$m['_return_rect']) === null || $bool49 === false || $bool49 === 0 || $bool49 === '' ?
			false :
	...
	$m['polygon']['__name__'] = 'polygon';

	$m['polygon']['__bind_type__'] = 0;
	$m['polygon']['__args__'] = [null,null,['surface'],['color'],['pointlist'],['width', 0]];
	$m['line'] = function(surface, color, point1, point2, width) {
		if (typeof width == 'undefined') width=arguments['callee']['__args__'][6][1];
		var $bool54,$bool55,$bool56,$bool52,$bool53,xmin,ymin,ymax,xpts,$eq27,ypts,$eq28,$attr113,$attr115,$attr114,$attr116,xmax;
		surface['beginPath']();
		...
		surface['stroke']();
		if ((($bool55=!(($bool54=$m['_return_rect']) === null || $bool54 === false || $bool54 === 0 || $bool54 === '' ?
			false :
	...
	$m['line']['__name__'] = 'line';

	$m['line']['__bind_type__'] = 0;
	$m['line']['__args__'] = [null,null,['surface'],['color'],['point1'],['point2'],['width', 1]];
	$m['lines'] = function(surface, color, closed, pointlist, width) {
		if (typeof width == 'undefined') width=arguments['callee']['__args__'][6][1];
		var $bool57,point,$bool58,$bool59,ypts,$eq30,$bool62,xmin,$iter6_iter,ymin,$iter6_nextval,ymax,$23,$24,$attr120,$iter6_type,$bool61,$bool60,xpts,$iter6_idx,$iter6_array,$eq29,$attr119,$attr118,$attr117,xmax;
		surface['beginPath']();
		...
		surface['stroke']();
		if ((($bool61=!(($bool60=$m['_return_rect']) === null || $bool60 === false || $bool60 === 0 || $bool60 === '' ?
			false :
	...
	$m['lines']['__name__'] = 'lines';

	$m['lines']['__bind_type__'] = 0;
	$m['lines']['__args__'] = [null,null,['surface'],['color'],['closed'],['pointlist'],['width', 1]];
	$m['aaline'] = function(surface, color, point1, point2, blend) {
		if (typeof blend == 'undefined') blend=arguments['callee']['__args__'][6][1];
		var rect;
		rect = $m['line'](surface, color, point1, point2);
		return rect;
	};
	$m['aaline']['__name__'] = 'aaline';

	$m['aaline']['__bind_type__'] = 0;
	$m['aaline']['__args__'] = [null,null,['surface'],['color'],['point1'],['point2'],['blend', 1]];
	$m['aalines'] = function(surface, color, closed, pointlist, blend) {
		if (typeof blend == 'undefined') blend=arguments['callee']['__args__'][6][1];
		var rect;
		rect = $m['lines'](surface, color, closed, pointlist);
		return rect;
	};
	$m['aalines']['__name__'] = 'aalines';

	$m['aalines']['__bind_type__'] = 0;
	$m['aalines']['__args__'] = [null,null,['surface'],['color'],['closed'],['pointlist'],['blend', 1]];
	...
	$m['_set_return']['__name__'] = '_set_return';

	$m['_set_return']['__bind_type__'] = 0;
	$m['_set_return']['__args__'] = ['args',null];
	$m['set_return'] = $m['_set_return'];
	return this;
}; /* end pyjsdl.draw */
...
/*
PYJS_DEPS: ['math.pi', 'math', 'pyjsdl.rect.Rect', 'pyjsdl', 'pyjsdl.rect', 'pyjsdl.color.Color', 'pyjsdl.color']
*/
