...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('__repr__', function() {
			...
			var $attr38,$attr37,$attr36,$attr35;
			return $p['sprintf']('%s(%r)', $p['tuple']([self['__class__'], self['__dict__']]));
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('render', function(text, antialias, color, background, surface) {
			...
			var $attr46,$attr47,$attr44,$attr45,$attr42,$attr43,$attr40,$attr41,$attr48,$attr49,$bool24,$bool21,$bool23,$bool22,surf,$attr39,$attr51,h,$attr52,w,$attr50;
	...
	, 1, [null,null,['self'],['text'],['antialias', true],['color', $p['tuple']([0, 0, 0])],['background', null],['surface', null]]);
		...
		$method = $pyjs__bind_method2('size', function(text) {
			...
			var $attr59,$attr58,$cmp1,$cmp2,$attr55,$attr54,$attr57,$attr56,$bool25,$bool26,$attr60,y,x,$attr53;
	...
	, 1, [null,null,['self'],['text']]);
		...
		$method = $pyjs__bind_method2('_size_estimate', function(text) {
			...
			var $attr67,$$char,$attr70,size,$attr68,$attr69,$iter9_iter,$attr64,$attr65,$23,$22,$iter9_nextval,$attr61,$attr62,$attr63,$bool27,$pyjs_try_err,$attr66,$24,$iter9_type,$iter9_idx,$25,$attr72,$attr71,$bool28,$21,$26,x,$iter9_array;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('set_bold', function(setting) {
			...
			if (typeof setting == 'undefined') setting=arguments['callee']['__args__'][3][1];
			var $28,$attr78,$attr77,$attr76,$27,$attr75;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('set_italic', function(setting) {
			...
			if (typeof setting == 'undefined') setting=arguments['callee']['__args__'][3][1];
			var $29,$attr82,$attr81,$attr84,$attr83,$30;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('_get_char_size', function(font) {
			...
			var $iter11_nextval,char_size,$$char,$iter10_nextval,chrs,$iter11_iter,$iter11_type,$iter10_array,$bool32,$bool31,fontsize,$iter11_idx,$iter11_array,$iter10_type,$iter10_iter,$iter10_idx;
			if ((($bool32=!(($bool31=font) === null || $bool31 === false || $bool31 === 0 || $bool31 === '' ?
				...
				char_size = $p['dict']([]);
				$iter10_iter = $p['tuple'](['abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', '0123456789', '.,:;?~!@#$%^&=+-*/\\_<>(){}[]\'" ']);
	...
	$m['SysFont'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(name, size, bold, italic) {
			...
			var $attr91,$attr92,$attr89,$32,$33,$31,$attr90,$34;
