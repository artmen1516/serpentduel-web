...
$pyjs['loaded_modules']['pyjsdl.cursors'] = function (__mod_name__) {
	...
	$m['compile'] = function(strings, black, white, xor) {
		...
		var $iter1_iter,$iter2_type,$iter2_iter,$2,$iter1_array,dbit,$eq1,$iter1_nextval,string,$eq2,$eq3,$len1,db,c,$eq4,$bool2,$bool3,$iter2_idx,$bool1,$bool4,$6,$4,$5,data,$3,$1,mbit,$iter2_nextval,$iter1_type,mb,i,j,mask,s,$iter1_idx,$assign2,$iter2_array;
		data = $p['list']([]);
		mask = $p['list']([]);
	...
	$m['create_cursor'] = function(size, data, mask) {
		var $iter3_type,$iter3_array,surface,$iter4_type,$iter4_iter,$cmp1,$iter3_idx,$iter3_nextval,black,$iter3_iter,white,$or1,$or2,$attr1,$attr2,$iter4_array,$9,$bool6,$bool7,$8,$bool5,$7,$bool8,$bool9,$14,$15,$16,$10,$11,$12,$13,i,$iter4_nextval,j,$iter4_idx,$len2,$assign3,$cmp2,y,x;
	...
	$m['get_cursor_types'] = function() {
		var types;
		types = $p['list'](['default', 'auto', 'none', 'context-menu', 'help', 'pointer', 'progress', 'wait', 'cell', 'crosshair', 'text', 'vertical-text', 'alias', 'copy', 'move', 'no-drop', 'not-allowed', 'e-resize', 'n-resize', 'ne-resize', 'nw-resize', 's-resize', 'se-resize', 'sw-resize', 'w-resize', 'ew-resize', 'ns-resize', 'nesw-resize', 'nwse-resize', 'col-resize', 'row-resize', 'all-scroll', 'zoom-in', 'zoom-out', 'grab', 'grabbing']);
		return types;
	};
	$m['get_cursor_types']['__name__'] = 'get_cursor_types';

	$m['get_cursor_types']['__bind_type__'] = 0;
	$m['get_cursor_types']['__args__'] = [null,null];
	return this;
}; /* end pyjsdl.cursors */
...
/*
PYJS_DEPS: ['pyjsdl.surface.Surface', 'pyjsdl', 'pyjsdl.surface', 'pyjsdl.color.Color', 'pyjsdl.color', 'pyjsdl.constants']
*/
